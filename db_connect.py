...
class dbconnect:
    ...
    def run(self):
        ...
        self.dlg.fileWidget.setStorageMode(0)
        ...
        if result:
            if self.dlg.cb_filterOnHeight.isChecked():
            ...
            if self.dlg.cb_filterOnVolumetricWeight.isChecked():
            ...
            selected = self.dlg.cmb_layers.currentLayer()
            print(selected)
